...
<div class="max-w-7xl mx-auto p-6">
    ...
    <div class="bg-white p-5 rounded-xl shadow mb-6">
        <form method="GET" action="{{ route('owner.laporan.index') }}" class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('owner.laporan.index') }}" class="px-5 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition">
                    Reset
                </a>
                @endif
                <a href="{{ route('owner.laporan.pdf', request()->all()) }}" class="bg-red-600 text-white px-5 py-2 rounded-lg hover:bg-red-700 transition">
                    Cetak PDF
                </a>
            </div>
        </form>
