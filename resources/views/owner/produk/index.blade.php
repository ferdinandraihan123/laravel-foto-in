            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900">{{ $product->nama_jasa }}</td>
                        <td class="px-6 py-4 text-gray-500">{{ $product->kategori->nama_kategori ?? '-' }}</td>
                        <td class="px-6 py-4 text-blue-700 font-semibold">Rp {{ number_format($product->harga,0,',','.')
                            }}</td>
                        <td class="px-6 py-4 text-gray-500">{{ $product->durasi }} Jam</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('owner.produk.show', $product->id_jasa) }}"
