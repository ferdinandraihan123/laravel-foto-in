...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
        <div class="p-8">
            ...
            <!-- Form Pembayaran -->
            <form action="{{ route('transaksis.prosesBayar', $transaksi->id_transaksi) }}" method="POST">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-200">
                        <a href="{{ route('transaksis.show', $transaksi->id_transaksi) }}" class="px-6 py-2 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-50 transition">
                            Batal
                        </a>
