            ...
            <div class="md:w-2/3 p-8">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Kategori: {{ $product->kategori->nama_kategori ?? '-' }}
                        </p>
                    </div>
                    <span
                        class="px-3 py-1 rounded-full text-sm font-medium {{ $product->status === 'aktif' ? '' : 'bg-red-100 text-red-800' }}">
                ...
                <div class="mt-6 space-y-4">
                    <div class="flex items-center border-b border-gray-100 pb-3">
                        ...
                        <div class="text-2xl font-bold text-blue-700">Rp {{ number_format((float) $product->harga, 0,
                            ',', '.') }}</div>
                    </div>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            <p class="text-gray-700 whitespace-pre-line">{{ $product->deskripsi ?: 'Tidak ada deskripsi'
                                }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 flex items-center space-x-4">
                    <a href="{{ route('admin.produk.index') }}"
                        class="px-6 py-3 border border-gray-300 rounded-full text-gray-800 hover:bg-gray-50 transition flex items-center">
                        Kembali
                    </a>
                </div>
            </div>
