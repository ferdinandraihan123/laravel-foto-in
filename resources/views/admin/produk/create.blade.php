        ...
        <form action="{{ route('admin.produk.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="nama_jasa" id="nama_jasa" value="{{ old('nama_jasa') }}" class="w-full rounded-lg focus:border-blue-500 focus:ring focus:ring-blue-200 border border-gray-300 pl-2 @error('nama_jasa') border-red-500 @enderror" required>
                    @error('nama_jasa')
                ...
                <div>
                    ...
                    <select name="id_kategori" id="id_kategori" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 border border-gray-300 pl-2" required>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 border border-gray-300 pl-2">{{ old('deskripsi') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga" id="harga" value="{{ old('harga') }}" class="w-full pl-10 rounded-lg focus:border-blue-500 focus:ring focus:ring-blue-200 border border-gray-300 @error('harga') border-red-500 @enderror" required>
                    </div>
                    @error('harga')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" step="0.5" name="durasi" id="durasi" value="{{ old('durasi') }}" class="w-full rounded-lg focus:border-blue-500 focus:ring focus:ring-blue-200 border border-gray-300 pl-2 @error('durasi') border-red-500 @enderror" required>
                    @error('durasi')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
